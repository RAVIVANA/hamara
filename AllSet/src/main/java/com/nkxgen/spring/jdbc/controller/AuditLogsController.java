...
public class AuditLogsController {
	...
	public String listAuditLogs(Model model) {
		...
		logger.info("Retrieved all audit logs.");
	...
	public String getAuditLogs(@RequestParam(defaultValue = "0") int page,
		...
		logger.info("Request received to retrieve audit logs. Page: {}, PageSize: {}", page, pageSize);
		...
		logger.info("Retrieved audit logs. Total Pages: {}", auditLogPage.getTotalPages());
